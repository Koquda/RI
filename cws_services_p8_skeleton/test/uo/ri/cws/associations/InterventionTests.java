...
public class InterventionTests {
    ...
    public void testWorkOrderInterventionLinked() {
        ...
        assertSame(intervention.getWorkOrder(), workOrder);
    }
    ...
    public void testUnlinkOnInterventionByWorkOrder() {
        ...
        assertEquals(0, workOrder.getInterventions().size());
    ...
    public void testMechanicInterventionLinked() {
        ...
        assertSame(intervention.getMechanic(), mechanic);
    }
    ...
    public void testUnlinkOnInterventionByMechanic() {
        ...
        assertEquals(0, mechanic.getInterventions().size());
    ...
    public void testSafeReturnOnMechanic() {
        ...
        assertEquals(0, intervenciones.size());
        assertEquals("It must be a copy of the collection or a read-only " +
                "version", 1, mechanic.getInterventions().size());
    }
    ...
    public void testSafeReturnOnWorkOrders() {
        ...
        assertEquals(0, intervenciones.size());
        assertEquals("It must be a copy of the collection or a read-only " +
                "version", 1, workOrder.getInterventions().size());
    }
