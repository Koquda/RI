...
public class ContractMappingTests {
    ...
    public void testRepeated() {
        ...
        ContractType otherType =
                new ContractType("other-contract-type-name", 12.0);
        ProfessionalGroup otherGroup =
                new ProfessionalGroup("other" + "-professional-group-name",
                        100.0, 20.0);
        Contract repeatedContract =
                new Contract(mechanic, otherType, otherGroup, 3000.0);
