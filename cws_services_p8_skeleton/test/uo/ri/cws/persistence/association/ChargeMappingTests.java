...
public class ChargeMappingTests {
    ...
    public void setUp() {
        ...
        unitOfWork.persist(client, cash, voucher, card, invoice, chargeWithCash,
                chargeWithCard, chargeWithVoucher);
    }

    @After
    public void tearDown() {
        unitOfWork.remove(client, cash, voucher, card, invoice, chargeWithCash,
                chargeWithCard, chargeWithVoucher);
        factory.close();
    }
    ...
    public void testCardRecoversCharges() {
        CreditCard restored =
                unitOfWork.findById(CreditCard.class, card.getId());
    ...
    public void testChargeForCashRecoversCharges() {
        Charge restored =
                unitOfWork.findById(Charge.class, chargeWithCash.getId());
    ...
    public void testChargeForVoucherRecoversCharges() {
        Charge restored =
                unitOfWork.findById(Charge.class, chargeWithVoucher.getId());
    ...
    public void testChargeForCardRecoversCharges() {
        Charge restored =
                unitOfWork.findById(Charge.class, chargeWithCard.getId());
