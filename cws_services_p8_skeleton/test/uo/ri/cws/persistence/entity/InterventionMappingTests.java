...
public class InterventionMappingTests {
    ...
    public void testAllFieldsPersisted() {
        ...
        Intervention restored =
                unitOfWork.findById(Intervention.class, intervention.getId());
        ...
        assertEquals(intervention.getSubstitutions(),
                restored.getSubstitutions());
    }
    ...
    public void testRepeated() {
        Intervention repeatedIntervention =
                new Intervention(intervention.getMechanic(),
                        intervention.getWorkOrder(), intervention.getDate(),
                        100);
