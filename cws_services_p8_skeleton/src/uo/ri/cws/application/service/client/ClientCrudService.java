...
public interface ClientCrudService {
     ...
     * @throws IllegalArgumentException when argument is null or dni is null
     *                                  or empty string
     * @throws BusinessException        if there already exists another
     *                                  client with the same dni
     */
    ClientDto addClient(ClientDto client) throws BusinessException;

    /**
     * @param idClient the id of the client to be deleted
     * @throws BusinessException        if the client does not exist or if
     *                                  there are vehicles
     ...
     * @throws IllegalArgumentException when the argument is null or id is
     *                                  null or empty
     */
    void updateClient(ClientDto client) throws BusinessException;

    /**
     * @return the list of all clients registered in the system. It might be
     * an empty list if there is no client
     * <p>
