...
public interface ContractService {
     ...
     * If there already exists an earlier contract for the same mechanic and
     * this is in force,
     ...
     *
     * @param c, contract business DTO. Consider only fields mechanic dni,
     *           type name,
     ...
     *                                  - end date, when no null, is not
     *                                  later than start date.
     * @throws IllegalArgumentException when:
     *                                  - argument is null, or
     *                                  - one of the mandatory values is null
     *                                  or empty String, or
     *                                  - professional group is FIXED_TERM
     *                                  and end date is null, or
     *                                  - annualBaseWage is not greater than 0
     */
    ContractDto addContract(ContractDto c) throws BusinessException;

    /**
     * It updates a contract that must be in force.
     * Only three of the fields in the argument will be considered: id to
     * identify the contract to update and
     * endDate (if not null in the argument) and annualBaseWage, to update
     * values stored.
     * <p>
     * If endDate provided is not null, it must be a valid future date and
     * will be updated. If it is null,
     * then contract endDate will be set to null.
     *
     * @param dto, just id, endDate and annualBaseWage are mandatory. Other
     *             fields in the argument
     *             will be ignored.
     * @throws BusinessException        when:
     *                                  - The contract does not exist, or
     *                                  - the contract is no longer in force, or
     *                                  - contract type is FIXED_TERM and end
     *                                  date is earlier than startDate, or
     *                                  - the contract is no longer in force.
     * @throws IllegalArgumentException when:
     *                                  - arg is null, or
     *                                  - id is null or empty, or
     *                                  - the annualBaseWage is a negative
     *                                  value.
     */
     ...
     */
    Optional<ContractDto> findContractById(String id) throws BusinessException;

    /**
     * @param mechanic id
     * @return a list with every ContractsByMechanic_BLDto registered for
     * this mechanic, probably empty
     * @throws BusinessException        DOES NOT
     * @throws IllegalArgumentException when id is null or empty.
     */
    List<ContractSummaryDto> findContractsByMechanicDni(String mechanicDni)
     ...
     * @throws IllegalArgumentException when id is null or empty.
     */
    List<ContractSummaryDto> findAllContracts() throws BusinessException;
