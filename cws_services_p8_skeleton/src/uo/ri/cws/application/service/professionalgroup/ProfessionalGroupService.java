...
public interface ProfessionalGroupService {
     ...
     *                                  already exists
     */
    ProfessionalGroupBLDto addProfessionalGroup(ProfessionalGroupBLDto dto)
     ...
     *                                  - arg is null, or
     *                                  - name is null or empty
     *                                  - the new trienniumSalary is
     *                                  negative, or
     *                                  - the new productivitySalary is negative
     * @throws BusinessException        if:
     *                                  - the group does not exist
     */
    void updateProfessionalGroup(ProfessionalGroupBLDto dto)
            throws BusinessException;
     ...
     */
    Optional<ProfessionalGroupBLDto> findProfessionalGroupByName(String id)
            throws BusinessException;
     ...
     * @throws BusinessException DOES NOT
     */
    List<ProfessionalGroupBLDto> findAllProfessionalGroups()
            throws BusinessException;

    class ProfessionalGroupBLDto {
        public String id;
        public long version;
