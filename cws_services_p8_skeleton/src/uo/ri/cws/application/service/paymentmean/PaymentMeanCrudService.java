...
public interface PaymentMeanCrudService {
     ...
     *                                  - There is another card registered
     *                                  with the same card number
     *                                  - The card to be inserted is outdated
     *                                  (expiration date before today)
     * @throws IllegalArgumentException if
     *                                  - The dto is null.
     *                                  - Any field of the following fields
     *                                  is null: id, cardExpiration,
     *                                  cardNumber, cardType, clientId
     *                                  - Any field of the following fields
     *                                  is empty: id, cardNumber,
     *                                  cardType, clientId
     * @formatter:off Registers a new Card in the system with the information received
     * @formatter:on
     */
     ...
     * @throws BusinessException        in case of:
     *                                  - Client does not exist.
     *                                  - There is another voucher registered
     *                                  with the same code
     * @throws IllegalArgumentException if
     *                                  - The dto is null.
     *                                  - Any field of the following is null:
     *                                  code, description or client id
     *                                  - Any field of the following is
     *                                  empty: code, description or client id
     *                                  - Field balance is negative
     * @formatter:off Registers a new Voucher in the system with the information received
     * @formatter:on
     */
     ...
     * @formatter:off Removes the payment mean from the system
     * @formatter:on
     */
