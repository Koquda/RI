...
public class HsqlDbClearAllTablesUnitOfWork {
    ...
    private static final String INSERT_DEFAULT_CONTRACT_TYPES =
            "INSERT INTO TCONTRACTTYPES" +
                    " (ID, VERSION, NAME, COMPENSATIONDAYS)" + " VALUES" +
                    " (?,1,'FIXED_TERM',4.2E0)," +
                    " (?,1,'PERMANENT',1.35E0)," + " (?,1,'TEMPORARY',3.25E0)";
    private static final String INSERT_DEFAULT_PROFESSIONAL_GROUPS =
            "INSERT INTO TPROFESSIONALGROUPS" +
                    "(ID, VERSION, NAME, TRIENNIUMPAYMENT, " +
                    "PRODUCTIVITYBONUSPERCENTAGE)" +
                    " VALUES" + " (?,1,'I',46.74E0,5.0E0)," +
                    " (?,1,'II',38.12E0,4.5E0)," +
                    " (?,1,'III',33.44E0,3.0E0)," +
                    " (?,1,'IV',28.85E0,3.5E0)," + " (?,1,'V',19.64E0,2.5E0)," +
                    " (?,1,'VI',14.78E0,2.0E0)," + " (?,1,'VII',11.25E0,1.5E0)";
    private final ConnectionData connectionData = PersistenceXmlScanner.scan();
    private PreparedStatement clearAllTables, insertDefaultContractTypes,
    ...
    private void prepareStatements(Connection con) throws SQLException {
        ...
        insertDefaultContractTypes =
                con.prepareStatement(INSERT_DEFAULT_CONTRACT_TYPES);
        insertDefaultProfessionalGroups =
                con.prepareStatement(INSERT_DEFAULT_PROFESSIONAL_GROUPS);
    }
