...
public class AddSteps {
    ...
    public void i_try_to_add_a_professional_group_with_negative_productivity_plus()
    ...
    public void i_register_a_new_professional_group(DataTable table)
        ...
        ProfessionalGroupBLDto pg =
                new ProfessionalGroupUtil().withName(row.get("name"))
                        .withProductivity(
                                Double.parseDouble(row.get("productivityRate")))
                        .withTriennium(
                                Double.parseDouble(row.get("trienniumPay")))
                        .get();
    ...
    public void the_professional_group_is_added(DataTable table) {
        ...
        String foundStr = found.name + "," + found.trieniumSalary + "," +
                found.productivityRate;
        assertEquals(1L, found.version);
        assertEquals(pgStr, foundStr);
