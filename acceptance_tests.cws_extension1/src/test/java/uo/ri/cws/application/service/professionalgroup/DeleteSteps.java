...
//		id = unit.get().id;
    ...
    public void i_del_this_professional_group() throws BusinessException {
        this.id2Del =
                ((ProfessionalGroupBLDto) ctx.get(Key.PROFESSIONALGROUP)).id;
    ...
    public void the_professional_group_is_deleted() {
        FindProfessionalGroupByIdSqlUnitOfWork unit =
                new FindProfessionalGroupByIdSqlUnitOfWork(this.id2Del);
        unit.execute();
        assertNull(unit.get());
    }
