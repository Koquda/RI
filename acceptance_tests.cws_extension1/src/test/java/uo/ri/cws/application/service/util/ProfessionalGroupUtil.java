...
public class ProfessionalGroupUtil {
    ...
    public static boolean match(ProfessionalGroupBLDto g1,
        ...
        return (match(g1.id, g2.id)) && (g1.version == g2.version) &&
                ...
                Math.abs(g1.productivityRate - g2.productivityRate) <
                        Double.MIN_NORMAL &&
                Math.abs(g1.trieniumSalary - g2.trieniumSalary) <
                        Double.MIN_NORMAL;
