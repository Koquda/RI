...
public class FindSteps {
    ...
    public void a_new_registered_contract_type() {
        ContractTypeUtil util =
                new ContractTypeUtil().withId("ZZZZZZ").withName("ZZZZZZ");
        util.register();
        dto = util.get();
    }
    ...
    public void contract_types_are_found(String arg) {
        ...
        assertEquals(allFound.size(), number);
    }
    ...
    public void i_search_a_non_existing_contract_type()
            throws BusinessException {
        optionalFound =
                service.findContractTypeByName(UUID.randomUUID().toString());
