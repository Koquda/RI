...
public class DeleteSteps {
    ...
    @Then("Current month payroll for this mechanic is deleted and the rest " +
            "remain")
    public void current_month_payroll_for_this_mechanic_is_deleted() {

        List<PayrollBLDto> payrollsInDB =
                getPayrollsInDBAfterDeletingOrderedByDate();
        ...
        assertEquals(payrollsBefore.size(), payrollsInDB.size());
    ...
    private List<PayrollBLDto> getPayrollsInserterdOrderedByDate() {
        @SuppressWarnings("unchecked") List<PayrollBLDto> list =
